@extends($template, ['titulo' => $titulo])
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body text-center py-4">
                    <div class="mb-3">
                        @if($type == "success")
                            <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="#198754" class="bi bi-check-circle-fill" viewBox="0 0 16 16">
                                ...
                                0-1.06 1.06L6.97 11.03a.75.75 0 0 0
                        ...
                        @elseif($type == "danger")
                            <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="#DC3545" class="bi bi-x-circle-fill" viewBox="0 0 16 16">
                                <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0M5.354
                                ...
                                0 0 0-.708-.708L8 7.293z"/>
                            </svg>
                        @else
                            <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="#0D6EFD" class="bi bi-info-circle-fill" viewBox="0 0 16 16">
                                <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0
                                0 16m.93-9.412-1 4.705c-.07.34.029.533.304.533.194
                                ...
                                2.29-.287zM8 5.5a1 1 0 1 1
                                0-2 1 1 0 0 1 0 2"/>
                            </svg>
                        @endif
                    </div>

                    <h4 class="text-{{ $type }} fw-bold mb-4">
                        {{ mb_strtoupper($message, 'UTF-8') }}
                    </h4>
                    ...
                    <x-button
                        ...
                        type="button"
                        route="{{ $link }}"
                        color="{{ $type == 'success' ? 'success' : ($type == 'danger' ? 'danger' : 'primary') }}"
                        class="px-4"
                    />
                </div>
            </div>
