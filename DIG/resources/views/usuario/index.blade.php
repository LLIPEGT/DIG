        ...
        <table class="table table text-center align-middle">
            ...
            <tbody>
                ...
                <tr>
                        ...
                        <td>{{ $item->email }}</td>
                    <td>
                        <a href="{{ route('usuario.show', $item->id) }}" class="btn btn-info">
                        ...
                        <a href="{{ route('usuario.edit', $item->id) }}"  class="btn btn-success">
                        ...
                        <form action="{{ route('usuario.destroy', $item->id) }}" style="display: inline;" method="POST">
                            @csrf
                            @method('DELETE')
